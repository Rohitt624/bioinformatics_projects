...
# Save PCA as object
pca <- ggplot(pcaData, aes(PC1, PC2, color=age, shape=celltype, alpha=GFP)) +
  geom_point(size=3) +
...
hsc_gfp_pos <- coldata$celltype == "HSC" & coldata$GFP == "POS"

res_postnatal_vs_adult <- results(dds,
    contrast = c("age","Postnatal","Adult"),
    subset = hsc_gfp_pos
)

res_old_vs_adult <- results(dds,
    contrast = c("age","Old","Adult"),
    subset = hsc_gfp_pos
)

res_old_vs_postnatal <- results(dds,
