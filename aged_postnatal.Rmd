...
conditions <- c("Y2P", "YMP", "Y2N", "YMN", "AM")
cdsub <- cd[cd$condition %in% conditions, ]
cdsub$condition <- factor(cdsub$condition, levels = c("Y2P", "Y2N", "YMP", "YMN", "AM"))
...
heatmap <- pheatmap(rloggenes, 
         ...
         cellheight = 10)
heatmap
ggsave("pnheatmap6.png", heatmap, height = 15, width = 10, dpi = 600)
