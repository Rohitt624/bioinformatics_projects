...
tbk1plot <- ggplot(df_ordered2, aes(x = reorder(sample, tbk1), y = tbk1, fill = Mutation)) + 
  geom_col() + 
  labs(title = "TBK1 Expression in MDS", x = "Sample", y = "TBK1 Expression (vst)") + 
  theme_bw() + 
  theme(axis.text.x = element_blank(),
        axis.ticks.x = element_blank())
tbk1plot

ggsave("tbk1_patientsamples_vst.png", tbk1plot, dpi = 600)
...
write.csv(df_ordered2, "tbk1expression.csv")
```
