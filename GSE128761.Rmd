...
so$acatage <- factor(so$acatage, levels = c("FALSE_HPC.E16.5", "FALSE_HPC.P7", "FALSE_HPC.P14", "FALSE_HPC.Adult", "TRUE_HPC.E16.5", "TRUE_HPC.P7", "TRUE_HPC.P14", "TRUE_HPC.Adult"))
...
ggsave("hpcheatmap4v3.png", heatmap, height = 15, width = 15, dpi = 600)
...
gfppn <- read.csv("C:/Users/rohit/OneDrive - Loyola University Chicago/Zhang Lab/RNASeq/Gene Signatures/gfppospnsignature.csv")
gfppn <- gfppn[,-1]
...
ggsave("hscheatmapv2.png", heatmap, height = 15, width = 10, dpi = 600)
