...
setwd("C:/Users/rohit/OneDrive - Loyola University Chicago/Zhang Lab/RNASeq/HPC GSE128761")
...
# Subset Ctnnal1+ cells from HPC.E16.5
group1_cells <- WhichCells(so, expression = orig.ident == "HPC.E16.5" & Ctnnal1_status == "Ctnnal1+")

# Subset all cells from hpc.Adult
group2_cells <- WhichCells(so, expression = orig.ident == "HPC.Adult")
...
# Subset Ctnnal1- cells from HPC.E16.5
group2_cells <- WhichCells(so, expression = orig.ident == "HPC.E16.5" & Ctnnal1_status == "Ctnnal1-")
...
# Subset Ctnnal1− cells from HPC.E16.5
group_neg_e16 <- WhichCells(so, expression = orig.ident == "HPC.E16.5" & Ctnnal1_status == "Ctnnal1-")

# Subset all cells from HPC.Adult
group_adult <- WhichCells(so, expression = orig.ident == "HPC.Adult")
...
# Subset Ctnnal1+ cells from HPC.P14
group1_cells <- WhichCells(so, expression = orig.ident == "HPC.P14" & Ctnnal1_status == "Ctnnal1+")
...
# Subset Ctnnal1− cells from HPC.P14
group2_cells <- WhichCells(so, expression = orig.ident == "HPC.P14" & Ctnnal1_status == "Ctnnal1-")
...
# Subset Ctnnal1− cells from HPC.P14
group_neg_p14 <- WhichCells(so, expression = orig.ident == "HPC.P14" & Ctnnal1_status == "Ctnnal1-")
...
ggplot(data, aes(x = Ctnnal1, y = Hmga2)) +
  geom_point() +
  labs(
    title = "Ctnnal1 vs Hmga2 Adult",
