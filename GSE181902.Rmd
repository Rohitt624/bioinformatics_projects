...
VlnPlot(mpp3, features = c("Fcgr3"), group.by = "newclusters", pt.size = 0) + 
  geom_jitter(width = 0.1, size = 0.5)
VlnPlot(mpp3, features = c("Esam"), group.by = "newclusters", pt.size = 0) + 
  geom_jitter(width = 0.1, size = 0.5)
...
VlnPlot(mpp3, features = "Esam neg signature1", group.by = "newclusters", pt.size = 0) + 
  geom_jitter(width = 0.1, size = 0.5)
VlnPlot(mpp3, features = "Esam pos signature1", group.by = "newclusters", pt.size = 0) + 
  geom_jitter(width = 0.1, size = 0.5)
...
```{r bubble plot}
data <- FetchData(mpp3, vars = c(list, "newclusters"))
