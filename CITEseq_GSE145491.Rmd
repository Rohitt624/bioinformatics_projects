...
```{r}
MkPspecific <- c("Maml2", "Mtss1l","Slc39a13", "Rell2", "Nrgn", "S100a1", "Lrch4", "Rnasek", "Doc2a", "Gucy1b3")
Meglin <- c("Selp", "Itga2b", "Itgb3", "Cd9")
Megcomb <- c("Maml2", "Mtss1l","Slc39a13", "Rell2", "Nrgn", "S100a1", "Lrch4", "Rnasek", "Doc2a", "Gucy1b3", "Selp", "Itga2b", "Itgb3", "Cd9")
```
