...
```{r featurescatter}
FeatureScatter(mpp3, feature1 = "adt_CD150", feature2 = "adt_ESAM", log = TRUE, group.by = "gate")
```
...
subsethsc <- FeatureScatter(hsc, feature1 = "adt_CD150", feature2 = "adt_ESAM", log = TRUE)
hsc <- CellSelector(subsetmpp3, object = hsc, ident = "ESAM-")
