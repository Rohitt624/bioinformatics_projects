...
mpp4$gate5 <- ifelse(cd62l$rna_ENSMUSG00000026581 > 0, "MPP4 CD62L+", "MPP4 CD62L-")
...
filter3$gating <- factor(filter3$gating, levels = c("HSC", "MPP1", "MPP2", "MPP3 ESAMhigh", "MPP3 ESAMmid", "MPP3 ESAMlow", "MPP4 CD62L+", "MPP4 CD62L-"))
DimPlot(filter3)
...
VlnPlot(filter3, features = "EPS1", group.by = "gating", pt.size = 0.5) + 
  labs(title="ESAM Positive Signature")
VlnPlot(filter3, features = "EPS1", group.by = "seurat_clusters") + 
  labs(title="ESAM Positive Signature")
...
VlnPlot(filter3, features = "ENS1", group.by = "gating", pt.size = 0) + 
  labs(title="ESAM Negative Signature")
VlnPlot(filter3, features = "ENS1", group.by = "seurat_clusters") + 
  labs(title="ESAM Negative Signature")
...
ggplot(sell, aes(x=sell$rna_ENSMUSG00000026581)) + 
  geom_histogram()
median(sell$rna_ENSMUSG00000026581)
sellsub <- subset(sell, sell$rna_ENSMUSG00000026581 > 0)
median(sellsub$rna_ENSMUSG00000026581)
