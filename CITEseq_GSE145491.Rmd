...
FeatureScatter(seurat_object, feature1 = "adt_CD150", feature2 = "adt_CD135", log = TRUE) + labs(title="CD135 CD150")
...
Verify
``` {r}
fullcount <- FetchData(seurat_object, vars = c("adt_CD150", "adt_CD135"))
mpp4count <- FetchData(mpp4, vars = c("adt_CD150", "adt_CD135"))
cd135count <- FetchData(cd135neg, vars = c("adt_CD150", "adt_CD135"))
countfull <- sum(fullcount$adt_CD150 > 0 & fullcount$adt_CD135 > 0)
countmpp4 <- sum(mpp4count$adt_CD150 > 0 & mpp4count$adt_CD135 > 0)
countcd135 <- sum(cd135count$adt_CD150 > 0 & cd135count$adt_CD135 > 0)
countfull
countmpp4
countcd135
```
