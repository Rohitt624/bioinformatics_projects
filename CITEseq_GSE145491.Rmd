...
ggsave("myeloid.png", gseaplot, dpi = 600, height = 4, width = 6)
```
...
ggsave("dc.png", gseaplot, dpi = 600, height = 4, width = 6)
```
...
ggsave("platelet.png", gseaplot, dpi = 600, height = 4, width = 6)
```
