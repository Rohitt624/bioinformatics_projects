...
plot_df <- FetchData(mpp3_filtered, vars = c("adt_ESAM", 
                                              ...
                                              "rna_ENSMUSG00000031162"))  # Fcgr3 — verify this ID

# Sort so low Fcgr3 cells plot first (high expression on top)
plot_df <- plot_df[order(plot_df$rna_ENSMUSG00000031162), ]

# Plot
fcgr3scatter <- ggplot(plot_df, aes(x = adt_ESAM, 
                                     y = rna_ENSMUSG00000030336, 
                                     color = rna_ENSMUSG00000031162)) +
...
fcgr3scatter
ggsave("mpp3esamcd27_fcgr3.png", fcgr3scatter, dpi = 600)
```
...
ggsave("myeloidv2.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("dc.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("plateletv2.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("cellcyclev2.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("erythroidv2.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("stemcellv2.png", gseaplot, dpi = 600, height = 8, width = 6)
```
