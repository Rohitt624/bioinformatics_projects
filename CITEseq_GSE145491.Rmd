...
gseaplot <- ggplot(table, aes(x=-log10(padj), y=pathway, fill = NES, size = size)) +
  geom_point(shape=21) + 
...
ggsave("myeloid.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("platelet.png", gseaplot, dpi = 600, height = 8, width = 6)
```
...
ggsave("cellcycle.png", gseaplot, dpi = 600, height = 8, width = 6)
```
