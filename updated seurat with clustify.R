...
gCMP <- c("D930028M14Rik","Ermap","Atp1b2","Sox5","Kel","Zg16","Slc25a21","Ptpn14","Tmem246","Tspan8","Pklr",
          "Prss50","Sphk1","Trib2","Ccl17","Rhag","Tspo2","Mogat2","Mmp14","Aqp1","Gml2","Gm13372","Car1",
          "Gm15915","Ccdc68")
...
geneSets <- GeneSetCollection(c(HSCSets, CMPSets, GMPSets, PGSets, PMSets, MEPSets))
