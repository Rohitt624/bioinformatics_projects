...
res1 <- DESeq2::results(dds, 
                       contrast = c("condition", "MPP3neg", "MPP3pos"),
                       independentFiltering = TRUE,)
rnk <- setNames(res1$log2FoldChange, rownames(res1))
rnk <- rnk[!is.na(rnk)]
gmt <- gmtPathways("C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/MPP3 RNA Seq/reactome_go_gsea.gmt")
...
```{r}
res1 <- DESeq2::results(dds, 
                       contrast = c("condition", "MPP3pos", "MPP3neg"),
                       independentFiltering = TRUE,)
rnk <- setNames(res1$log2FoldChange, rownames(res1))
rnk <- rnk[!is.na(rnk)]
gmt <- gmtPathways("C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/MPP3 RNA Seq/reactome_go_gsea.gmt")
...
write.csv(gseadf, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/MPP3 RNA Seq/mpp3gsea.csv")
```
