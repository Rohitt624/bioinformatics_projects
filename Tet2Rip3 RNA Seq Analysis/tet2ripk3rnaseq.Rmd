...
id_list <- sapply(split(gene_ids[["mgi_symbol"]], gene_ids[["ensembl_gene_id"]]), paste, collapse = ";")
...
write.csv(res, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/res221599v2.csv")
```
...
res121747.up <- res121747[which(res121747$logFC>0.8),]
res121747.down <- res121747[which(res121747$logFC < -0.8),]
res221599$gene <- rownames(res221599)
res221599$gene <- sub("\\..*", "", res221599$gene)
res221599.2 <- res221599[which(abs(res221599$logFC)>0.8),]
res221599.up <- res221599[which(res221599$logFC>0.8),]
res221599.down <- res221599[which(res221599$logFC < -0.8),]
res83918$gene <- rownames(res83918)
res83918$gene <- sub("\\..*", "", res83918$gene)
res83918.2 <- res83918[which(abs(res83918$logFC)>0.8),]
res83918.up <- res83918[which(res83918$logFC>0.8),]
res83918.down <- res83918[which(res83918$logFC < -0.8),]
res90976$gene <- rownames(res90976)
res90976$gene <- sub("\\..*", "", res90976$gene)
res90976.2 <- res90976[which(abs(res90976$logFC)>0.8),]
res90976.up <- res90976[which(res90976$logFC>0.8),]
res90976.down <- res90976[which(res90976$logFC < -0.8),]


overlap <- Reduce(intersect, list(res121747.2$gene, res83918.2$gene, res221599.2$gene, res90976.2$gene))
overlapup <- Reduce(intersect, list(res121747.up$gene, res83918.up$gene, res221599.up$gene, res90976.up$gene))
overlapdown <- Reduce(intersect, list(res121747.down$gene, res83918.down$gene, res221599.down$gene, res90976.up$gene))
...
write.csv(overlapup, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/overlapup.csv")
write.csv(overlapdown, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/overlapdown.csv")
```
power
