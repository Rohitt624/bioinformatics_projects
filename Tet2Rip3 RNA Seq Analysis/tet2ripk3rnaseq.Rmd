...
GSE83918 <- DESeqDataSetFromMatrix(countData = cts, colData = cd, design = ~ condition)
GSE83918$condition <- relevel(GSE83918$condition, ref="WT")
```

```{r}
GSE83918 <- DESeq(GSE83918)
res83918 <- results(GSE83918)
write.csv(res221599, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/results83918.csv")
```
...
cts <- EnsIDReplace(cts)
cd <- read.csv("C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/coldataGSM2221611.csv") 
GSE221599 <- DESeqDataSetFromMatrix(countData = cts, colData = cd, design = ~ condition)
GSE221599$condition <- relevel(GSE221599$condition, ref="WT")
```

```{r}
GSE221599 <- DESeq(GSE221599)
res221599 <- results(GSE221599)
write.csv(res221599, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/results221599.csv")
```
