...
res <- DESeq2::results(GSE221599, 
                       contrast = c("condition", "DM", "WT"),
                       independentFiltering = TRUE,
)

#write results as csv
write.csv(res, "C:/Users/rthalla/OneDrive - Loyola University Chicago/Zhang Lab/Kanak Tet2 Ripk3/Gene List Validation/res221599.csv")
```
