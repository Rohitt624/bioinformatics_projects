...
tf2 <- read.csv("output/filtereddkotet2_tlymph2.csv")
...
ggsave("dkotet2_tlymph.png", tfplot, dpi = 600, height = 8.5, width = 8)

ggsave("dkotet2_cellcycle.png", ccplot, dpi = 600, height = 8.5, width = 8)
```

#### DKO vs WT comparison results
```{r Generate Plots - DKO vs WT, fig.width=10, fig.height=9}
tf <- read.csv("output/filtereddkowt_tlymph2.csv")
...
ggsave("dkowt_tlymph2.png", tfplot, dpi = 600, height = 8.5, width = 8)

ggsave("dkowt_cellcycle.png", ccplot, dpi = 600, height = 8.5, width = 8)
```
